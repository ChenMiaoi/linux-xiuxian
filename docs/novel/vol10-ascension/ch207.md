...
<ChapterGate
  id="ch207-s1"
  title="节奏之试"
  prompt="主线合并窗口前，用于集成各子系统下一周期补丁、提前发现冲突的树通常叫什么？"
  answer="linux-next"
  placeholder="输入破关答案"
/>
...
<ChapterGate
  id="ch207-s2"
  title="回归之试"
  prompt="当补丁修复用户报告的回归时，指向公开报告、帮助工具关联修复的标签是什么？"
  answer="Closes"
  placeholder="输入破关答案"
/>
...
<ChapterGate
  id="ch207-s3"
  title="稳定之试"
  prompt="希望重要 bug 修复被稳定版团队注意并回移时，补丁标签区常加入哪个 Cc 地址？"
  answer="stable@vger.kernel.org"
  placeholder="输入破关答案"
/>
...
<ChapterGate
  id="ch207-note"
  title="道藏复核"
  prompt="发布周期里，新功能集中进入主线的两周窗口叫什么？"
  answer="Merge Window"
  placeholder="输入破关答案"
/>
