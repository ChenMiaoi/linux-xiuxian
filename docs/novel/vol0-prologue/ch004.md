...
<ChapterGate
  id="vol0-prologue-ch004-s03"
  title="二、状态寄存器 sstatus试炼"
  prompt="本小节要读者掌握的关键机制或术语是什么？"
  answer="寄存器"
  placeholder="输入本节关键答案"
/>
...
<ChapterGate
  id="vol0-prologue-ch004-s05"
  title="四、栈帧试炼"
  prompt="本小节重点讲到的关键函数、宏或接口是什么？"
  answer="outer_function"
  placeholder="输入本节关键答案"
/>
