...
int main() {
    ...
    printf("位域偏移:\n");
    printf("  present:  %zu\n", __builtin_bit_offsetof(struct pte, present));
    printf("  writable: %zu\n", __builtin_bit_offsetof(struct pte, writable));
    printf("  user:     %zu\n", __builtin_bit_offsetof(struct pte, user));
    printf("  address:  %zu\n", __builtin_bit_offsetof(struct pte, address));
    printf("  nx:       %zu\n", __builtin_bit_offsetof(struct pte, nx));
