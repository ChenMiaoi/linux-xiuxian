...
<ChapterGate
  id="vol0-prologue-ch002-s06"
  title="五、container_of试炼"
  prompt="本小节重点讲到的关键函数、宏或接口是什么？"
  answer="container_of"
  placeholder="输入本节关键答案"
/>
